...
public class HTMLCleaner {
     ...
     */
    public static String[] fetchWords(String url) throws UnknownHostException, MalformedURLException, IOException {
    ...
    public static String fetchHTML(String link) {
    	try {
			...
			System.out.println("Cannot fetch link " + link);
		}
    	return null;
    }
    ...
    public static String stripEntities(String html) {
    	return html.replaceAll("(?s)&[A-z#]*[0-9]*;", "");
    }
}
